...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2022 at 11:25 PM
...
CREATE TABLE `fudbaler` (
  `idFudbaler` bigint(20) NOT NULL,
  `Ime` varchar(50) DEFAULT NULL,
  `Prezime` varchar(50) DEFAULT NULL,
  `BrojDresa` bigint(20) DEFAULT NULL,
  `Pozicija` bigint(20) DEFAULT NULL,
...
INSERT INTO `fudbaler` (`idFudbaler`, `Ime`, `Prezime`, `BrojDresa`, `Pozicija`, `Zemlja`) VALUES
(11, 'Novak ', 'Djokovic', 15, 1, 199),
(17, 'Mate', 'Vujasinovic', 12, 1, 1),
(18, 'Bozidar', 'Vujasinovic', 10, 5, 199);
...
INSERT INTO `pozicija` (`idPozicija`, `Naziv`) VALUES
(1, 'GK'),
(2, 'CB'),
(3, 'CAM'),
(4, 'CF'),
...
(121, 'Kuwait'),
(122, 'Kyrgyzstan'),
(123, 'Lao People Democratic Republic'),
(124, 'Latvia'),
(125, 'Lebanon'),
(126, 'Lesotho'),
(127, 'Liberia'),
...
--
ALTER TABLE `fudbaler`
  MODIFY `idFudbaler` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
-- Constraints for table `fudbaler`
--
ALTER TABLE `fudbaler`
  ADD CONSTRAINT `fudbaler_ibfk_1` FOREIGN KEY (`Pozicija`) REFERENCES `pozicija` (`idPozicija`),
  ADD CONSTRAINT `fudbaler_ibfk_2` FOREIGN KEY (`Zemlja`) REFERENCES `zemlja` (`idZemlje`);
COMMIT;
